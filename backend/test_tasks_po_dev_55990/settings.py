"""
Django settings for test_tasks_po_dev_55990 project.
...
ROOT_URLCONF = 'test_tasks_po_dev_55990.urls'
...
WSGI_APPLICATION = 'test_tasks_po_dev_55990.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_tasks_po_dev_55990 API",
    "DESCRIPTION": "API documentation for test_tasks_po_dev_55990 App",
    "VERSION": "v1",
}
