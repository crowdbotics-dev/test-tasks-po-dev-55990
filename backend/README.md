...
## Project Structure
    ...
    ├── test_tasks_po_dev_55990  # Django project configurations
...
1. Clone this repo and `cd test_tasks_po_dev_55990`
...
2. Clone this repo and `cd test_tasks_po_dev_55990`
